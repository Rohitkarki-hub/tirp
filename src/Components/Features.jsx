...
import img from "../assets/imgs/feature.jpg";
import pic1 from "../assets/imgs/service.png";
import pic2 from "../assets/imgs/user.png";
import pic3 from "../assets/imgs/wallet.png";
    ...
    <div className="min-h-screen flex flex-col lg:flex-row items-center md:mx-32 mx-5 gap-14">
      <div className="w-full lg:w-2/4">
        <div className="space-y-4 ">
          ...
          <p>
            Discover the Best Holiday Experiences with TripPixie! We`&apos`re
